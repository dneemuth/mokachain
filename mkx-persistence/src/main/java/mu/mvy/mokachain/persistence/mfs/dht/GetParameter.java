...
public class GetParameter {
	     ...
	     * @param type
	     */
	    public GetParameter(String key, String type)
	    {
	        this.key = key;
	        this.type = type;
	    }
	     ...
	     * @param owner
	     */
	    public GetParameter(String key, String type, String owner)
	    {
	        this(key, type);
	        this.ownerId = owner;
	    }
	     ...
	     * @param c
	     */
	    public GetParameter(MfsContent c)
	    {
	        this.key = c.getKey();
	     ...
	     * @param md
	     */
	    public GetParameter(MfsStorageEntryMetadata md)
	    {
	        this.key = md.getKey();
