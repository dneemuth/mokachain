 ...
 * @since 20140226
 */
public class StorageEntryMetadata  implements MfsStorageEntryMetadata {
	    ...
	    public StorageEntryMetadata(MfsContent content)
	    {
	    ...
	    {
	        if (o instanceof MfsStorageEntryMetadata)
	        {
