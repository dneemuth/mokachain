...
public class Block {
    ...
    /**
     * Initial coin offering from coinbase
     */
    ...
    public static final double COINBASE = 100;
    ...
    public Block createGenesisBlock() {
    	 ...
    	 try {
	    	...
	    	coinbase = new Transaction(COINBASE, keyPair.getPublic());	    	  
	    	
	    	List<Transaction> txes = new ArrayList<Transaction>();
	    	txes.add(coinbase);
	    	genesisBlock.setTransactions(txes);
	    	
	    	genesisBlock.merkleRoot = calculateMerkleRoot();
